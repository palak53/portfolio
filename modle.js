$(document).ready(function() {
  ...
  var modalText = {
    Kaggle: {
      ...
      tag: 'DATA ANALYSIS',
      detail:
        'Indian food varieties analysis using pandas',
      link: 'https://www.kaggle.com/palakmejpara/notebook1'
    },
    tableau: {
      title: 'Data analysis - Tableau',
      tag: 'DATA ANALYSIS',
      detail:
        'US crime data insight',
      link: 'https://public.tableau.com/profile/palak5760#!',
    },
    django: {
      title: 'Book Hub',
      tag: 'DJANGO FRAMEWORK',
      detail:
        'BOOK HUB is web app, where users can share and read books',
      link: 'https://github.com/palak53/Book_Hubb'
    },
    roambi: {
      title: 'Roambi.com',
      ...
      link: 'https://www.linkedin.com/in/palak-mejpara-7bb31317b/'
    },
    walker: {
      title: 'WalkerTracker',
